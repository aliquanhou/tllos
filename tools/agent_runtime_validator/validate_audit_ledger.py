...
VALID_EVENT_TYPES = [
    ...
    "GOVERNANCE_VERIFIED",
    "EXECUTION_OBSERVED",
    "EXECUTION_METRICS_GENERATED",
    "EXECUTION_INSIGHT_CREATED",
    "ADAPTIVE_FEEDBACK_CREATED",
    "ADAPTATION_PROPOSAL_CREATED",
    "ADAPTATION_PROPOSAL_REVIEWED",
    ...
    "FRAME_HASH_GENERATED",
    "FRAME_STORED",
    "VISION_FRAME_SEQUENCE_CREATED",
    "VISION_OBJECT_TRACKED",
    "VISION_MEMORY_UPDATED",
    "VISION_REPLAY_VERIFIED"
]
